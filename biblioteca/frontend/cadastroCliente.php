...
<body class="bg-branco">
  <main class="overflow-y-hidden">
    <h2 class="text-center text-branco-20 chamada-login">Bem-vindo ao <span
        class="text-azul-10 d-block">BookStats</span></h2>
    ...
    <div class="bg-light p-5 position-absolute top-50 start-50 translate-middle bg-light rounded w-25">
      ...
      <form action="../backend/clientes/salvarCliente.php" method="post">
        <div class="mb-4">
          <label for="nome" class="d-block">Nome</label>
          <input type="text" name="nome" id="nome" class="d-block input-texto w-100" required>
        </div>
        ...
        <input type="submit" class="btn-padrao w-100" value="Cadastrar">
      </form>
    </div>
  </main>
  <footer>
